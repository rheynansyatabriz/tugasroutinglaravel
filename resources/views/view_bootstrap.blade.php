        ...
        <nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
            ...
            <div class="container py-2 px-4">
                ...
                <a href="#" class="navbar-brand mb-0 h1">
                    <img class="ing-fluid" src="images/logo-white.png" alt="logo white">
                </a>
                <!-- Navbar Toggler -->
            ...
            <div class="offcanvas offcanvas-end bg-purple" id="offcanvasNavbar">
                ...
                <div class="offcanvas-body pt-0 px-4">
                    ...
                    <!-- Top Menu -->
                    <ul class="nabvar-nav flex-row flex-wrap">
                        <li class="nav-item col-6 col-md-auto"><a href="#"class="nav-link active"></a>Docs</a></li>
                        <li class="nav-item col-6 col-md-auto"><a href="#"class="nav-link active"></a>Examples</a></li>
                        <li class="nav-item col-6 col-md-auto"><a href="#"class="nav-link active"></a>Icons</a></li>
                        <li class="nav-item col-6 col-md-auto"><a href="#"class="nav-link active"></a>Themes</a></li>
                        <li class="nav-item col-6 col-md-auto"><a href="#"class="nav-link active"></a>Blog</a></li>
                    </ul>
                    <hr class="d-md-none text-white-50"> <!--Horizontal Line -->
                    ...
                    <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                        ...
                        <li class="nav-item col-6 col-md-auto">
                            ...
                            <li class="nav-item col-6 col-md-auto">
                                <a href="#" class="nav-link avtive">
                                    <i class="bi-slack"></i><small class="ms-2d-md-none">Slack</small>
                                </a>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="dropdown" data-bs-theme="light">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li><hr class="dropdown-divider"></li>
                                        <li><button class="dropdown-item"type="button"><small>all version</small> </button></li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item col-12 col-lg-auto">
            ...
            <div class="container py-5 px-4">
                <div class="row">
                    <div class="col-md-5 order-md-2">
                        <img class="ing-fluid" src="images/main.png" alt="main logo">
                    </div>
                    <div class="col-md-7 order-md-1">
                        <h1 class="mt-3 display-3">Build fast, responsive sites with Bootstrap</h1>
                        <p class="fs-5 mt-3">Quickly design and customize responsive mobile-first sites with Bootstrap, the world's most popular dront-end open source toolkit, featuring Sass variables and mixins, responsive grid system, extensive prebuilt components, and powerful Javascript plugins.</p>
                        <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-3 mb-5">
                        <a href="#" class="logo text-decoration-none">
                            <div class="d-flex">
                                <img class="img-fluid" src="images/logo-black.png" alt="Bootstrap Logo" style="width: 40px;">
                    ...
                    <div class="col-6 col-lg-2 offset-lg-1 mb-5"></div>
                        <h5>Links</h5>
                    ...
                    <div class="col-6 col-lg-2 mb-5">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-2"><a href="#">Corporate sponsor</a></li>
